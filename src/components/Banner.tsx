    ...
    <div ref={scrollContiner} className='relative mb-6 bg-linen max-md:h-[50vh] h-[70vh] text-center grid place-items-center'>
        <div>
          <div className='flex gap-5'>
            <Image src={'/star-6.svg'}  width={80} height={80} className='max-sm:w-10 max-xxsm:hidden'  alt='star' />
        ...
        <div
          onClick={scrollDown}
          className="text-[50px]  inline-block max-sm:p-3 p-6 bg-darkorange-100 text-white rounded-full hover:cursor-pointer hover:shadow-xl hover:bg-white hover:text-darkorange-100"
        >
          <FaArrowDownLong className="max-sm:text-[38px] " />
        </div>
